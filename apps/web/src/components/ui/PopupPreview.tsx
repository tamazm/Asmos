...
export function PopupPreview() {
  return (
    ...
    >
      ...
      {/* Floating conversion rate badge — prominent banner style */}
      <div
        className="absolute -bottom-4 -left-4 flex items-center gap-3 rounded-2xl px-4 py-3 z-20"
        style={{
          background: "#165DFF",
          boxShadow: "0 8px 24px rgba(22,93,255,0.35), 0 2px 6px rgba(22,93,255,0.2)",
        }}
      >
        <span className="text-2xl font-bold text-white tabular-nums tracking-tight">+23%</span>
        <div className="flex flex-col">
          <span className="text-[11px] font-semibold text-white leading-tight">conversion</span>
          <span className="text-[11px] font-semibold text-white/70 leading-tight">lift</span>
        </div>
      </div>
    </div>
  );
