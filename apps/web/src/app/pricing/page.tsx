    ...
    <div className="flex min-h-[100dvh] flex-col bg-[color:var(--color-surface)]">
      ...
      <section className="px-5 py-16 sm:py-24">
        <div className="mx-auto max-w-xl text-center reveal">
          ...
          <Link href={CTA.secondary.href} className="inline-flex items-center gap-2 rounded-full bg-[color:var(--color-primary)] px-6 py-3 text-sm font-semibold text-white transition-[background-color,transform] duration-200 hover:bg-[color:var(--color-primary-dark)] active:scale-[0.97]">
            {CTA.secondary.label}
          </Link>
        </div>
      </section>
